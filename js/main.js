...
/* harmony import */ var _vendor_datepicker_min__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/datepicker.min */ "./src/js/vendor/datepicker.min.js");


var $arrow = $('#arrow');
var $yellowSlice = $('.scale__slice--yellow');
var $greenSlice = $('.scale__slice--green');
var $blueSlice = $('.scale__slice--blue');

var scale = function scale(count, end) {
...
$yellowSlice.on('click', function () {
  $arrow.removeClass().addClass('yellow');
  var $count = $('.result__number').text();
  scale($count, 800);
});
$greenSlice.on('click', function () {
  $arrow.removeClass().addClass('green');
  var $count = $('.result__number').text();
  scale($count, 1000);
});
$blueSlice.on('click', function () {
  $arrow.removeClass().addClass('blue');
  var $count = $('.result__number').text();
  scale($count, 1200);
});
...
!function (t, e, i) {
  !function () {
    ...
    n = m, n.prototype = {
      ...
      return "object" == _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(t) ? (t = n.getParsedDate(t), new Date(t.year, t.month, t.date)) : void 0;
